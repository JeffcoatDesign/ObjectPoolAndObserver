...
namespace Chapter.ObjectPool
{
    public class DroneObjectPool : MonoBehaviour
    {
        ...
        public IObjectPool<Drone> Pool { get
            {
                if (_pool == null)
                    _pool = new ObjectPool<Drone>(CreatePooledItem, OnTakeFromPool, OnReturnedToPool, OnDestroyPoolObject, true, stackDefaultCapacity, maxPoolSize);
                return _pool;
            } }
